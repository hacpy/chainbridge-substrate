...
pub mod pallet {
    use frame_support::{
        dispatch::DispatchResultWithPostInfo, pallet_prelude::*, weights::GetDispatchInfo,
        Parameter,
    };
    ...
    pub enum Event<T: Config> {
        ...
        RelayerAdded(<T as frame_system::Config>::AccountId),
        /// Relayer removed from set
        RelayerRemoved(<T as frame_system::Config>::AccountId),
    ...
    #[pallet::type_value]
    pub(super) fn RelayerThresholdDefault<T: Config>() -> u32 {
    ...
    pub(super) type RelayerThreshold<T: Config> =
        StorageValue<_, u32, ValueQuery, RelayerThresholdDefault<T>>;
    ...
    pub(super) type Resources<T: Config> = StorageMap<_, Blake2_256, ResourceId, Vec<u8>>;
